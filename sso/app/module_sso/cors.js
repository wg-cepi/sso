                ...
                if(response.status === "ok") {
                    if($("userLogged")) {
                       loginArea.hide();
                        ...
                        var html = "<ul id='id-sso-links'><li><a href='./?token=" + response.token + "' title='" + response.email + "'>Continue as " + response.email + "</a></li>";
                        html += "<li><a id='id-relog' href='#' title='Log in as another user'>Login in as another user</a></li></ul>";
