...
define('CFG_SQL_USERNAME', 'sso');
define('CFG_SQL_PASSWORD', 'sso');
define('CFG_JWT_ISSUER', 'sso.local');
define('CFG_SSO_URL', 'http://sso.local');
...
/* Google Plus */
define('CFG_G_CLIENT_ID', '8518470472686-3n51ffn8p9jhnc83e50fve62tc7uaokq.apps.googleusercontent.com');
